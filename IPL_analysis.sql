    ...
    SELECT
        CASE
            ...
            WHEN winner IN ('Delhi Daredevils', 'Delhi Capitals')
                THEN 'Delhi Capitals'
            WHEN winner IN ('Royal Challengers Bangalore', 'Royal Challengers Bengaluru')
...
-- Standardizing inconsistent venue names

WITH standardized_venues AS (
    SELECT
        CASE
            WHEN venue IN ('Wankhede Stadium', 'Wankhede Stadium, Mumbai')
